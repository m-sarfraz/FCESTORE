...
if(isset($_GET["search"])){
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM company_profile where company_name Like '%$search%'");
    ...
    $sql="SELECT * FROM company_profile where company_name Like '%$search%'";
...
<style>
 ...
 padding: 320px;
background:url("images/teapic20.jpg");
padding-left: 750px;
font-size: 32px;	
color: aliceblue;
