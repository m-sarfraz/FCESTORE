...
//fetching data in descending order (lastest entry first)
//$result = mysql_query("SELECT * FROM users ORDER BY id DESC"); // mysql_query is deprecated
$result = mysqli_query($mysqli, "SELECT * FROM shop where product_type='tea bags' "); 
...
$sql='SELECT * FROM shop where product_type="tea bags" LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
