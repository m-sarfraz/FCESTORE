...
$user_scheck_query =  "SELECT * FROM teabuyers_signup where email='$search'";
$result = mysqli_query($mysqli, $user_scheck_query);
	...
	if($user['email']=== $search){
		...
		echo "<script type='text/javascript '> alert('$message');window.location='teabuyer_forgot_passwd.php'</script>";
	}
...
{    
    ...
    $password = password_hash($password, PASSWORD_DEFAULT);
        ...
        //updating the table
        $result = mysqli_query($mysqli, "UPDATE teabuyers_signup SET password='$password' WHERE username='$name1'");
              ...
              <div class="panel-body">
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <form id="register-form" action="teabuyer_newpswd.php" role="form" autocomplete="off" class="form" method="post">
