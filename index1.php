...
.my-float{
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
    ...
    <body>
        ...
        <div class="container">
   <br>
   <a  href="index.html"><img src="images/logocelonhouse.jpg" class="center" style="position:relative; left:380;" width="380" height="200"></a>
   <h1 align="center"-><b>Welcome To ceylonteahouse Online Chat</b></h1><br >
  ...
  <h3 align="center">A place to help others</a></h3><br >
   <div class="row">
    <div class="col-md-8 col-sm-6">
     <a href="homepage.php" style="color:white;" class="nav-link">Back to Web</a>
    </div>
    ...
    <div class="col-md-2 col-sm-3">
     <p align="right">Welcome <?php echo $_SESSION['username']; ?>  <a href="teabuyers_login.php"><b style="color:RED;">Exit</b></a></p>
    </div>
   </div>
...
<div id="group_chat_dialog" style="background-color:forestgreen;" title="Group Chat Section">
 <div id="group_chat_history" style="height:350px; color:aqua;   background-image:url(images/web.jpg); background-repeat:no-repeat;background-size:cover; border:1px solid #ccc; overflow-y: auto; margin-bottom:24px; padding:16px;">
 ...
 <div class="form-group" align="right">
  <button type="button" style="background-color: darkgreen;" name="send_group_chat" id="send_group_chat" class="btn btn-info">Send</button>
 </div>
</div>
