...
$sql="SELECT * FROM  membership join teabuyers_signup on membership.user_id=teabuyers_signup.user_id  WHERE industry_name='{$_SESSION['name']}' AND confirmation='Pending' ";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif; font-size:17px;">
 ...
 padding: 300px;
background:url("images/teapic31.jpg");
padding-left: 800px;
font-size: 38px;	
color: aliceblue;
...
height: 600px;
	...
	<div id="example1">
	<p style="color: #000000">Requested tea buyers</p>
...
while($res = mysqli_fetch_array($result)) { 
    ...
    echo '  <td class="total">'; echo "<a href=\"membership_accept.php?id=$res[member_id]\">View</a> | <a href=\"reject_member.php?id=$res[member_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Reject</a><br><br>";    echo "</h4></p>"; 
    echo ' </tr>'; }
?>
     </tbody>
				</table>
