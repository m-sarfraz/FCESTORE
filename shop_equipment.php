...
//fetching data in descending order (lastest entry first)
//$result = mysql_query("SELECT * FROM users ORDER BY id DESC"); // mysql_query is deprecated
$result = mysqli_query($mysqli, "SELECT * FROM shop where product_type='Equipment' "); 
...
$sql='SELECT * FROM shop where product_type="Equipment" LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
    	...
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				...
    				<td style="padding-left: 120px;font-size: 24px;">	<a href="shop_fertilizer.php">Fertilizer</a></td>
