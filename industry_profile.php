...
if ($result) { // if user exists
  if ($result->num_rows==0) {
    ...
    window.location.href='company_seller_homepage.php';</script>";
  }
 }
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown" id="div1" style="height:100px;">
	...
	<div class="container register" style="width: 100%;">
		<form  method="post" action="industry_profile.php" >&nbsp;&nbsp;
				 <div class="file btn btn-small btn-primary" style="width: 200px; height: 200px;"> 
                       <?php  
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" style="padding-top: 2px;">
								
                
                                <div class="row register-form" style="padding-top: 2px;">
                                    <div class="col-md-6">
