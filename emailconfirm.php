...
$code = $_GET['code'];
$user_check_query = "SELECT * FROM `teabuyers_signup` WHERE `username`='$username'";
...
if($code == $db_code)
{
    	mysqli_query($db,"UPDATE `teabuyers_signup` SET `confirm`='1' ");
	mysqli_query($db,"UPDATE `teabuyers_signup` SET `confirmcode`='0'");
